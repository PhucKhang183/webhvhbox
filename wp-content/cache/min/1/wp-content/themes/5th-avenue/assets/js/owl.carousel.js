  ...
  Video.prototype.thumbnail = function (target, video) {
    var tnLink,
      ...
      create = function (path) {
        icon =
          '<div class="av5_video_button owl-video-play-icon"><span class="av5_video_icon"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="25" viewBox="0 0 15 25"><defs><style>.cls-1{fill:#fff;fill-rule:evenodd}</style></defs><path class="cls-1" d="M-.021 24.528l14.41-12.081L-.021.5v24.028z"></path></svg></span></div>';
