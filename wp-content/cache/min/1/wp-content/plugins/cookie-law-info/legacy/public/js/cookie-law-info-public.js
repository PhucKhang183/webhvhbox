...
var CLI = {
  ...
  set: function (args) {
    ...
    if (
      Boolean(this.settings.scroll_close) === !0 &&
      cli_hidebar_on_readmore === !1
    ) {
  ...
  hideBarInReadMoreLink: function () {
    if (
      Boolean(CLI.settings.button_2_hidebar) === !0 &&
  ...
  acceptRejectCookies(element, action = "custom") {
    var open_link =
      element[0].hasAttribute("href") && element.attr("href") != "#" ? !0 : !1;
    var new_window = !1;
    if (action == "accept") {
    ...
    if (CLI.js_blocking_enabled === !1) {
      if (Boolean(Cli_Data.ccpaEnabled) === !0) {
        if (
          ...
          Boolean(Cli_Data.ccpaBarEnabled) === !1
        ) {
          cliBlocker.cookieBar(!1);
        }
      } else {
  ...
  barAsWidget: function (a) {
    ...
    if (this.settings.widget_position == "left") {
      cli_elm.css({ left: "15px", right: "auto", bottom: "15px", top: "auto" });
    } else {
  ...
  CookieLawInfo_Callback: function (enableBar, enableBlocking) {
    ...
    enableBlocking =
      typeof enableBlocking !== "undefined" ? enableBlocking : !0;
    if (
      CLI.js_blocking_enabled === !0 &&
      Boolean(Cli_Data.custom_integration) === !0
    ) {
