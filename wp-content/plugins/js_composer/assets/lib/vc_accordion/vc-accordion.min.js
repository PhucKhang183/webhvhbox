...
!(function ($) {
  ...
  function Plugin(action, options) {
    ...
    return (
      ...
      this.each(function () {
        var $this, data;
        (data = ($this = $(this)).data("vc.accordion")) ||
  ...
  ((Accordion = function ($element, options) {
    ...
    for (transition in ((el = document.createElement("vcFakeElement")),
    (transitions = {
    ...
    (Accordion.prototype.controller = function (options) {
      ...
      "string" != typeof action &&
        ...
        void 0 === action && (action = Accordion.DEFAULT_TYPE),
    ...
    (Accordion.prototype.getTarget = function () {
      ...
      return (
        (selector = (that = this).getSelector()),
        (getTarget = function () {
          var element;
          return (
            (element = that.getContainer().find(selector)).length ||
    ...
    (Accordion.prototype.getTriggers = function () {
      ...
      return (
        ...
        this.getContainer()
          ...
          .each(function () {
            var accordion, $this;
            void 0 === (accordion = ($this = $(this)).data("vc.accordion")) &&
    ...
    (Accordion.prototype.getActiveTriggers = function () {
      return this.getTriggers().filter(function () {
        var accordion;
        return (accordion = $(this).data("vc.accordion"))
          .getTarget()
          .hasClass(accordion.activeClass);
      });
    }),
    (Accordion.prototype.changeLocationHash = function () {
      var id, $target;
      ($target = this.getTarget()).length && (id = $target.attr("id")),
        id &&
          (history.pushState
    ...
    (Accordion.prototype.getAnimationDurationMilliseconds = function () {
      var duration;
      return "ms" === (duration = this.getAnimationDuration()).substr(-2)
        ? parseInt(duration)
        : "s" === duration.substr(-1)
    ...
    (Accordion.prototype.collapse = function (opt) {
      ...
      ($this = this.$element),
        ($triggers = this.getActiveTriggers().filter(function () {
          return $this[0] !== this;
        })).length && Plugin.call($triggers, "hide", opt),
        Plugin.call($this, "show", opt);
    }),
    ...
    (Accordion.prototype.scrollToActive = function (opt) {
      ...
      (void 0 === opt || void 0 === opt.scrollTo || opt.scrollTo) &&
        ($targetElement = $((that = this).getTarget())).length &&
        this.$element.length &&
        setTimeout(function () {
          $targetElement.offset().top -
            $(window).scrollTop() -
            1 * that.$element.outerHeight() <
            0 &&
            $("html, body").animate(
              {
                scrollTop:
                  $targetElement.offset().top - 1 * that.$element.outerHeight(),
              },
              300
            );
        }, 300);
