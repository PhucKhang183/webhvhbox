...
!(function ($) {
  ...
  ((Tabs = function (element, options) {
    ...
    return (
      ...
      void 0 === (that = this).useCacheFlag && (this.useCacheFlag = useCache()),
      this.useCacheFlag
    );
  }),
        ...
        (filterElements = function () {
          ...
          if (
            ($elements = tab.getContainerAccordion().filter(function () {
              ...
              return (
                void 0 ===
                  (accordion = ($that = $(this)).data("vc.accordion")) &&
                  ($that.vcAccordion(),
    ...
    (changeHandler = function (e) {
      var caller;
      void 0 === (caller = $(e.target).data("vc.accordion")).getRelatedTab &&
            ...
            (findTargets = function () {
              return caller
                ...
                .filter(function () {
                  var $this;
                  return (
                    void 0 === ($this = $(this)).data("vc.accordion") &&
                      $this.vcAccordion(),
                    $this.data("vc.accordion").getSelector() ===
                      caller.getSelector()
                  );
                });
            }),
